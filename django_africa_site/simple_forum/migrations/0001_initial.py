...
import django_africa_site.simple_forum.models
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='simple_forum.ForumCategory')),
            ],
        ),
        migrations.CreateModel(
            name='Tags',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='simple_forum.ForumCategory')),
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('tags', models.ManyToManyField(to='simple_forum.Tags')),
            ],
        ),
        migrations.CreateModel(
            name='Vote',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('topic', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='simple_forum.Topic')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_pic', models.FileField(blank=True, max_length=500, null=True, upload_to=django_africa_site.simple_forum.models.img_url)),
                ('send_mailnotifications', models.BooleanField(default=False)),
                ('badges', models.ManyToManyField(to='simple_forum.Badge')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='topic',
            name='votes',
            field=models.ManyToManyField(to='simple_forum.Vote'),
        ),
        migrations.CreateModel(
            name='Google',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='comment_parent', to='simple_forum.Comment')),
                ('topic', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='topic_comments', to='simple_forum.Topic')),
                ('votes', models.ManyToManyField(to='simple_forum.Vote')),
            ],
        ),
        migrations.CreateModel(
            name='Attachment',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_on', models.DateTimeField(auto_now_add=True)),
                ('attached_file', models.FileField(blank=True, max_length=500, null=True, upload_to=django_africa_site.simple_forum.models.img_url)),
                ('comment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='simple_forum.Comment')),
